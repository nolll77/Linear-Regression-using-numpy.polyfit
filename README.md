...
![linear function example slope intercept](https://drive.google.com/file/d/1IhIT-_CrztXVGW7PJCjuROcv0K0u0yia/view?usp=sharing)
...
linear regression scatter plot example one student
...
Predictions: Based on your linear regression model, if a student tells you how much she studied for the exam, you can come up with a pretty good estimate: you can predict her results even before she writes the test. Let’s say someone studied 20 hours; it means that her predicted test result will be 2.01 * 20 - 3.9 = 36.3.
Outliers: If something unexpected shows up in your dataset – someone is way too far from the expected range…
otlier detection with linear regression
...
Getting the data
Defining x values (the input variable) and y values (the output variable)
Machine Learning: fitting the model
Interpreting the results (coefficient, intercept) and calculating the accuracy of the model
Visualization (plotting a graph)
